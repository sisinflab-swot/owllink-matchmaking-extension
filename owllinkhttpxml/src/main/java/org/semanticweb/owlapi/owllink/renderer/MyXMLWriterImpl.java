...
public class MyXMLWriterImpl implements XMLWriter {
    ...
    @Override
    public void writeStartElement(IRI iri) throws IOException, IllegalElementNameException {
        this.writeStartElement(iri.toString());
    }
    ...
    public void writeAttribute(IRI iri, String s) throws IOException {
        this.writeAttribute(iri.toString(), s);
    }
    ...
    public void startDocument(IRI iri) throws IOException {
        this.startDocument(iri.toString());
    }
