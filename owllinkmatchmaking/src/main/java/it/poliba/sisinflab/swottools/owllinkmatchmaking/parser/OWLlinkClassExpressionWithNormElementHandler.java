...
public class OWLlinkClassExpressionWithNormElementHandler extends AbstractOWLlinkResponseElementHandler<ClassExpressionWithNorm> {
    private OWLClassExpression owlClassExpression;
    private Norm norm;

    public OWLlinkClassExpressionWithNormElementHandler(OWLXMLParserHandler handler) {
        super(handler);
    }
    ...
    @Override
    public ClassExpressionWithNorm getOWLLinkObject() throws OWLXMLParserException {
        return new ClassExpressionWithNormImpl(owlClassExpression, norm);
    }
}
