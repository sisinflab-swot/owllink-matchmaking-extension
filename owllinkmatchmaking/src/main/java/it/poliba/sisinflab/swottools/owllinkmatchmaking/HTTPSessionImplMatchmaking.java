...
import it.poliba.sisinflab.swottools.owllinkmatchmaking.parser.OWLlinkMatchmakingXMLParserHandler;
import it.poliba.sisinflab.swottools.owllinkmatchmaking.renderer.OWLlinkMatchmakingXMLRenderer;
...
public class HTTPSessionImplMatchmaking extends HTTPSessionImpl {


    public HTTPSessionImplMatchmaking(OWLOntologyManager manaager, URL reasonerURL, PrefixManagerProvider prov) {
        super(manaager, reasonerURL, prov);
    }
    ...
    public ResponseMessage performRequests(Request<?>... request) {
        ...
        try (StringWriter out = new StringWriter();
            ...
            //Handle the request
            OWLlinkXMLRenderer renderer = new OWLlinkMatchmakingXMLRenderer();
            ...
            try (Reader reader = new InputStreamReader(is)) {
                ...
                OWLlinkXMLParserHandler handler = new OWLlinkMatchmakingXMLParserHandler(manager.createOntology(), prov, askedRequests, null);
