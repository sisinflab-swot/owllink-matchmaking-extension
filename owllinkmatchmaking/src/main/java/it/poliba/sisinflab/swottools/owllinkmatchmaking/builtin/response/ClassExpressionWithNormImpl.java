...
public class ClassExpressionWithNormImpl implements ClassExpressionWithNorm {
    ...
    public ClassExpressionWithNormImpl(OWLClassExpression owlClassExpression, Norm norm, String warning) {
        this.warning = warning;
        this.norm = norm;
        this.owlClassExpression = owlClassExpression;
    }

    public ClassExpressionWithNormImpl(OWLClassExpression owlClassExpression, Norm norm) {
        this(owlClassExpression, norm, null);
    }
